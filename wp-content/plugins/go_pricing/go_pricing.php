					...
					foreach ( $pricing_tables as $pricing_table ) {
						if 	( isset ( $pricing_table['table-id'] ) && $pricing_table['table-id'] == $id ) {
							...
							for ( $x = 0; $x < $colnum ; $x++ ) {
								...
								$generated_table .= '<div class="gw-go-col-wrap' . ( $pricing_table['col-highlight'][$x] == '1' ? ' gw-go-current' : '' ) . ( isset( $pricing_table['col-disable-enlarge'][$x] ) && $pricing_table['col-disable-enlarge'][$x] == '1' ? ' gw-go-disable-enlarge' : '' ) . '">';
