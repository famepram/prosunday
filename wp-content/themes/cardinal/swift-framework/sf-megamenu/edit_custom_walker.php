	            ...
	            <dt class="menu-item-handle">
	                ...
	                <span class="item-controls">
	                    ...
	                    <span class="item-order hide-if-js">
	                        ...
	                        ?>" class="item-move-up"><abbr title="<?php esc_attr_e('Move up', 'swift-framework-admin'); ?>">&#8593;</abbr></a>
	                        |
	                        <a href="<?php
	                            echo wp_nonce_url(
	                                add_query_arg(
	                    ...
	                    <a class="item-edit" id="edit-<?php echo $item_id; ?>" title="<?php esc_attr_e('Edit Menu Item', 'swift-framework-admin'); ?>" href="<?php
	        ...
	        <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
	           ...
	           <!-- <p class="field-custom description description-wide">
	            ...
	            <div class="sf-menu-options">
		            ...
		            <p class="field-custom description description-wide">
		                <label for="edit-menu-megamenu-<?php echo $item_id; ?>"><?php _e( 'Enable Mega Menu', 'swift-framework-admin' ); ?><input type="checkbox" id="edit-menu-megamenu-<?php echo $item_id; ?>" class="edit-menu-item-custom" id="menu-megamenu[<?php echo $item_id; ?>]" name="menu-megamenu[<?php echo $item_id; ?>]" value="1" <?php echo checked( !empty( $item->megamenu ), 1, false ); ?> />
		                </label>
		            </p>
		            <p class="field-custom description description-wide">
            			<label for="edit-menu-megamenucols-<?php echo $item_id; ?>"><?php _e( 'Mega Menu Columns', 'swift-framework-admin' ); ?></label> 
            			<select class="fat" id="edit-menu-megamenucols-<?php echo $item_id; ?>" name="menu-megamenucols[<?php echo $item_id; ?>]">
            				<?php for ($i = 1; $i <= 6; $i++) {
		            ...
		            <p class="field-custom description description-wide">
		                <label for="edit-menu-loggedinvis-<?php echo $item_id; ?>"><?php _e( 'Visible only when logged in', 'swift-framework-admin' ); ?><input type="checkbox" id="edit-menu-loggedinvis-<?php echo $item_id; ?>" class="edit-menu-item-custom" id="menu-loggedinvis[<?php echo $item_id; ?>]" name="menu-loggedinvis[<?php echo $item_id; ?>]" value="1" <?php echo checked( !empty( $item->loggedinvis ), 1, false ); ?> />
		                </label>
		            </p>
		            ...
		            <p class="field-custom description description-wide">
		                <label for="edit-menu-menuitembtn-<?php echo $item_id; ?>"><?php _e( 'Button Style Menu Item', 'swift-framework-admin' ); ?><input type="checkbox" id="edit-menu-menuitembtn-<?php echo $item_id; ?>" class="edit-menu-item-custom" id="menu-menuitembtn[<?php echo $item_id; ?>]" name="menu-menuitembtn[<?php echo $item_id; ?>]" value="1" <?php echo checked( !empty( $item->menuitembtn ), 1, false ); ?> />
		                </label>
		            </p>
		            
		            <?php } ?>
		            
		            <p class="field-custom description description-thin" style="height: auto;overflow: hidden;width: 50%;float: none;">
		                 <label for="edit-menu-item-icon-<?php echo $item_id; ?>"><?php _e( 'Menu Icon (Gizmo / Font Awesome)', 'swift-framework-admin' ); ?><input type="text" id="edit-menu-item-icon-<?php echo $item_id; ?>" class="widefat edit-menu-item-custom" name="menu-item-icon[<?php echo $item_id; ?>]" placeholder="ss-star" value="<?php echo esc_attr( $item->menuicon ); ?>" />
		                 </label>
		             </p>
