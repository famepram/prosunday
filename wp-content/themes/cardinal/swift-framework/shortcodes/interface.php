...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<script language="javascript" type="text/javascript" src="<?php echo get_template_directory_uri() ?>/swift-framework/shortcodes/sf.shortcodes.js"></script>
		<script language="javascript" type="text/javascript" src="<?php echo get_template_directory_uri() ?>/swift-framework/shortcodes/sf.shortcode.embed.js"></script>
		...
		<link href="<?php echo get_template_directory_uri() ?>/swift-framework/shortcodes/base.css" rel="stylesheet" type="text/css" />
		<link href="<?php echo get_template_directory_uri() ?>/swift-framework/shortcodes/sf-shortcodes-style.css" rel="stylesheet" type="text/css" />
					...
					<fieldset>
						...
						<div id="shortcode-icons" class="shortcode-option">
							...
							<div class="option">
								...
								<p class="info">If you'd like to override the default color customiser value (link in the WP Admin Bar), then please enter a hex colour value (including #).</p>
							</div>
						</div>
						...
						<div id="shortcode-modal" class="shortcode-option">
							...
							<div class="option">
								<label for="modal-button-icon"><?php _e('Modal Button Icon (Icon Reveal Only)', 'swift-framework-admin'); ?></label>
