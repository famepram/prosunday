...
<?php if (have_posts()) : the_post(); ?>
	...
	<!-- OPEN article -->
	<article <?php post_class('clearfix single-portfolio-'.$fw_media_display); ?> id="<?php the_ID(); ?>" itemscope itemtype="http://schema.org/CreativeWork">
		...
		<section class="page-content clearfix <?php echo $page_content_class; ?>">
			...
			<div class="content-wrap <?php echo $content_wrap_class; ?> clearfix" itemprop="description"><?php the_content(); ?></div>
