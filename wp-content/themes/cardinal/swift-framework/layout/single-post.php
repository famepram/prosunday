<?php
	...
	if ($sidebar_config == "right-sidebar") {
		...
		$content_wrap_class = apply_filters('sf_post_content_wrap_class_leftsidebar', 'col-sm-8 content-right');
	} else {
	...
	/* RELATED */
	if (!$show_author_info) {
		remove_action('sf_post_content_end', 'sf_post_info', 40);
	}
...
<?php if (have_posts()) : the_post(); ?>
	...
	<!-- OPEN article -->
	<article <?php post_class('clearfix single-post-'.$fw_media_display); ?> id="<?php the_ID(); ?>" itemscope itemtype="http://schema.org/BlogPosting">
