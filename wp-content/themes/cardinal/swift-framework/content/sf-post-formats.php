<?php
	...
	*/
	...
	if (!function_exists('sf_sh_video_post')) {
		function sf_sh_video_post($postID, $video_width, $video_height, $use_thumb_content) {
	...
	if (!function_exists('sf_post_thumbnail')) { 
		function sf_post_thumbnail($blog_type = "", $fullwidth = "no") {
			...
			$item_figure .= '<figure class="animated-overlay overlay-alt thumb-media-'.$thumb_type.'">';
	...
	if (!function_exists('sf_post_item_link')) { 
		function sf_post_item_link() {
			...
			if ($thumb_link_type == "link_to_url") {
				...
				$link_config = 'href="'.$thumb_img_url.'" class="lightbox" rel="ilightbox[posts]"';
				...
				$link_config = 'href="'.$lightbox_image_url.'" class="lightbox" rel="ilightbox[posts]"';	
				$item_icon = apply_filters('sf_post_lightbox_icon', "ss-view");
