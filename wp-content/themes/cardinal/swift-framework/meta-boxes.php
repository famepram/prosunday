	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			array(
				...
				'desc'  => __('The image that will be used as the background for the fancy header. This will override the alt background selection.', 'swift-framework-admin'),
