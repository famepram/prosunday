<?php
	...
	*/
	...
	if (!function_exists('sf_woo_header_add_to_cart_fragment')) {
		function sf_woo_header_add_to_cart_fragment( $fragments ) {
			...
			<li class="parent shopping-bag-item">
				<a class="cart-contents" href="<?php echo $woocommerce->cart->get_cart_url(); ?>" title="<?php _e('View your shopping cart', 'swiftframework'); ?>"><i class="ss-cart"></i><?php echo $woocommerce->cart->get_cart_total(); ?><span class="num-items"><?php echo $cart_count_text; ?></span></a>
					...
					<li>                                      
						<div class="shopping-bag">
							...
							<?php if ( $cart_count != "0" ) { ?>
								...
								<div class="bag-header"><?php echo $cart_count_text; ?> <?php _e('in the cart', 'swiftframework'); ?></div>
							    ...
							    <div class="bag-buttons">
							    	...
							    	<a class="sf-button standard sf-icon-reveal bag-button" href="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>"><i class="ss-view"></i><span class="text"><?php _e('View cart', 'swiftframework'); ?></span></a>
							...
							<?php } else { ?>
								...
								<div class="bag-empty"><?php _e('Unfortunately, your cart is empty.','swiftframework'); ?></div>                                   
	...
	================================================== */
	$options = get_option('sf_cardinal_options'); 
	...
	if (!function_exists('sf_product_share')) {
		...
		?>
			<div class="article-share product-share" data-buttontext="<?php _e("Share this", "swiftframework"); ?>" data-image="<?php echo $image[0]; ?>"></div>
		<?php }
	...
	if (!function_exists('sf_product_meta')) {
		...
		?>
			<div class="meta-row clearfix">
				<span class="need-help"><?php _e("Need Help?", "swiftframework"); ?> <a href="#email-form" class="inline accent" data-toggle="modal"><?php _e("Contact Us", "swiftframework"); ?></a></span>
				<span class="leave-feedback"><a href="#feedback-form" class="inline accent" data-toggle="modal"><?php _e("Leave Feedback", "swiftframework"); ?></a></span>
			</div>
