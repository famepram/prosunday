	...
	*/
	...
	if (!function_exists('sf_head_meta')) {
		function sf_head_meta() {
			...
			<?php } ?>
			<?php if (isset($sf_options['custom_ios_title']) && $sf_options['custom_ios_title'] != "") { ?><meta name="apple-mobile-web-app-title" content="<?php echo __($sf_options['custom_ios_title'], 'swiftframework'); ?>">
			<?php } ?>
			
			<!--// PINGBACK & FAVICON //-->
			<link rel="pingback" href="<?php bloginfo( 'pingback_url' ); ?>" />
			<?php if (isset($sf_options['custom_favicon']['url']) && $sf_options['custom_favicon']['url'] != "") { ?><link rel="shortcut icon" href="<?php echo $sf_options['custom_favicon']['url']; ?>" /><?php } ?>
			
			<?php if (isset($sf_options['custom_ios_icon144']['url']) && $sf_options['custom_ios_icon144']['url'] != "") { ?>
			<link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo $sf_options['custom_ios_icon144']['url']; ?>" />
			<?php } ?>
			<?php if (isset($sf_options['custom_ios_icon114']['url']) && $sf_options['custom_ios_icon114']['url'] != "") { ?>
			<link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo $sf_options['custom_ios_icon114']['url']; ?>" />
			<?php } ?>
			<?php if (isset($sf_options['custom_ios_icon72']['url']) && $sf_options['custom_ios_icon72']['url'] != "") { ?>
			<link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo $sf_options['custom_ios_icon72']['url']; ?>" />
			<?php } ?>
			<?php if (isset($sf_options['custom_ios_icon57']['url']) && $sf_options['custom_ios_icon57']['url'] != "") { ?>
			<link rel="apple-touch-icon-precomposed" sizes="57x57" href="<?php echo $sf_options['custom_ios_icon57']['url']; ?>" />
			<?php } ?>
	...
	if (!function_exists('sf_page_classes')) {
		function sf_page_classes() {
			...
			// Page Transtions
			if ($enable_page_transitions && ($page_slider == "" || $page_slider == "none")) { 
