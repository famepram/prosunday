<?php
	...
	*/
		...
		function sf_footer_promo() {
			...
			<div id="base-promo" class="sf-promo-bar promo-<?php echo $footer_promo_bar_type; ?>">
				...
				<?php } else if ($footer_promo_bar_type == "arrow") { ?>
					<a href="<?php echo $footer_promo_bar_button_link; ?>" target="<?php echo $footer_promo_bar_button_target; ?>"><?php echo $footer_promo_bar_text; ?><i class="ss-navigateright"></i></a>
				<?php } else { ?>
					<a href="<?php echo $footer_promo_bar_button_link; ?>" target="<?php echo $footer_promo_bar_button_target; ?>"><?php echo $footer_promo_bar_text; ?></a>
				<?php } ?>
			<!--// CLOSE #base-promo //-->
			</div>
			<?php }
	...
	if (!function_exists('sf_footer_copyright')) {
		function sf_footer_copyright() {
			...
			<footer id="copyright" class="<?php echo $copyright_class; ?>">
				<div class="container">
					<div class="text-left"><?php echo do_shortcode(stripslashes($copyright_text)); ?><?php echo $swiftideas_backlink; ?></div>
					...
					<?php } else { ?>	
						<div class="text-right"><?php echo do_shortcode(stripslashes($copyright_text_right)); ?></div>
					<?php } ?>
				</div>
			<!--// CLOSE #copyright //-->
			</footer>
	...
	if (!function_exists('sf_option_parameters')) {
		...
		?>
			<div id="sf-option-params" data-slider-slidespeed="<?php echo $slider_slideshowSpeed;?>" data-slider-animspeed="<?php echo $slider_animationSpeed;?>" data-slider-autoplay="<?php echo $slider_autoplay;?>" data-carousel-pagespeed="<?php echo $carousel_paginationSpeed;?>" data-carousel-slidespeed="<?php echo $carousel_slideSpeed;?>" data-carousel-autoplay="<?php echo $carousel_autoplay;?>" data-carousel-pagination="<?php echo $carousel_pagination;?>" data-lightbox-nav="<?php echo $lightbox_nav; ?>" data-lightbox-skin="<?php echo $lightbox_skin; ?>" data-lightbox-sharing="<?php echo $lightbox_sharing; ?>"></div>
	...
	if (!function_exists('sf_loveit_locale')) {
		function sf_loveit_locale() { 
			...
			?>
			<div id="loveit-locale" data-ajaxurl="<?php echo $ajax_url; ?>" data-nonce="<?php echo $nonce; ?>" data-alreadyloved="<?php echo $already_loved_message; ?>" data-error="<?php echo $error_message; ?>" data-loggedin="<?php echo $logged_in; ?>"></div>
		<?php }
	...
	if (!function_exists('sf_system_info')) {
		function sf_system_info() {
			if (isset($_GET['sf_debug']) && $_GET['sf_debug'] == true) {
	            ...
	            echo '<h3>' . __( 'Cardinal Debug', 'swiftframework' ) . '</h3>';
