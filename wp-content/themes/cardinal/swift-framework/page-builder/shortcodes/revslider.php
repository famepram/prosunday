...
SPBMap::map( 'spb_slider', array(
    "name"		=> __("Rev/Layer/Master Slider", "swift-framework-admin"),
    "base"		=> "spb_slider",
    "class"		=> "spb_revslider",
    ...
    "params"	=> array(
        ...
        array(
            "type" => "textfield",
            "heading" => __("Master Slider ID", "swift-framework-admin"),
            "param_name" => "masterslider_id",
            "value" => "",
            "description" => __("Enter the Master Slider ID here for the one that you wish to show. This can be found within the Master Slider Admin Panel.", "swift-framework-admin")
        ),
        array(
            "type" => "dropdown",
            ...
            "description" => __("Select if you'd like the slide to be full width (edge to edge). NOTE: only possible on pages without sidebars.", "swift-framework-admin")
        ),
        array(
            "type" => "textfield",
