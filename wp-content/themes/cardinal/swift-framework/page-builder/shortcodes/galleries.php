...
class SwiftPageBuilderShortcode_spb_galleries extends SwiftPageBuilderShortcode {
    ...
    protected function content($atts, $content = null) {
		   	...
		   	$title = $width = $el_class = $exclude_categories = $output = $tax_terms = $items = $el_position = '';
	        ...
	        /* GALLERIES
	        ================================================== */	        
	        $items = sf_galleries($display_type, $link_type, $fullwidth, $gutters, $columns, $show_title, $show_subtitle, $show_excerpt, $excerpt_length, $item_count, $category, $pagination, $sidebars);
...
SPBMap::map( 'spb_galleries', array(
    ...
    "params"	=> array(
        ...
        array(
            ...
            "value" => array(__('Standard', "swift-framework-admin") => "standard", __('Gallery', "swift-framework-admin") => "gallery", __('Masonry', "swift-framework-admin") => "masonry", __('Masonry Gallery', "swift-framework-admin") => "masonry-gallery"),
