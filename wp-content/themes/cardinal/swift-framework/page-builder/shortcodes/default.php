	...
	SPBMap::map( 'spb_divider',  array(
	    ...
	    "params"	=> array(
	        array(
	            ...
	            "param_name" => "type",
	            "value" => array(__('Standard', "swift-framework-admin") => "standard", __('Thin', "swift-framework-admin") => "thin", __('Dotted', "swift-framework-admin") => "dotted", __('Heading', "swift-framework-admin") => "heading", __('Go to top (text)', "swift-framework-admin") => "go_to_top", __('Go to top (Icon 1)', "swift-framework-admin") => "go_to_top_icon1", __('Go to top (Icon 2)', "swift-framework-admin") => "go_to_top_icon2"),
