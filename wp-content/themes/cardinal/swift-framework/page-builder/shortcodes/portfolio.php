...
class SwiftPageBuilderShortcode_spb_portfolio extends SwiftPageBuilderShortcode {
    ...
    protected function content($atts, $content = null) {
		   	...
		   	$title = $width = $el_class = $exclude_categories = $multi_size_ratio = $output = $tax_terms = $items = $el_position = '';
	        ...
	        /* PORTFOLIO ITEMS
	        ================================================== */	        
	        $items = sf_portfolio_items($display_type, $multi_size_ratio, $fullwidth, $gutters, $columns, $show_title, $show_subtitle, $show_excerpt, $hover_show_excerpt, $excerpt_length, $item_count, $category, $exclude_categories, $pagination, $sidebars);
...
SPBMap::map( 'spb_portfolio', array(
    ...
    "params"	=> array(
        ...
        array(
            ...
            "value" => array(__('Standard', "swift-framework-admin") => "standard", __('Gallery', "swift-framework-admin") => "gallery", __('Masonry', "swift-framework-admin") => "masonry", __('Masonry Gallery', "swift-framework-admin") => "masonry-gallery", __('Multi Size Masonry', "swift-framework-admin") => "multi-size-masonry"),
