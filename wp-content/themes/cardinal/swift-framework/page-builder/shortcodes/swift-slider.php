...
class SwiftPageBuilderShortcode_spb_swift_slider extends SwiftPageBuilderShortcode {
    ...
    protected function content($atts, $content = null) {
            ...
            $output .= "\n\t\t\t". do_shortcode('[swift_slider type="slider" category="'.$category.'" fullscreen="'.$fullscreen.'" max_height="'.$maxheight.'" slide_count="'.$slidecount.'" loop="'.$loop.'" nav="'.$nav.'" pagination="'.$pagination.'"]');
            $output .= "\n\t\t".'</div>';
...
SPBMap::map( 'spb_swift_slider', array(
    ...
    "params"	=> array(
        array(
            ...
            "value" => array(__('Yes', "swift-framework-admin") => "true", __('No', "swift-framework-admin") => "false"),
