	...
	*/
	...
	class SwiftPageBuilderShortcode_spb_blog extends SwiftPageBuilderShortcode {
	    ...
	    protected function content($atts, $content = null) {
		    ...
		    $title = $width = $el_class = $output = $gutters = $fullwidth = $columns = $show_read_more = $offset = $posts_order = $content_output = $items = $item_figure = $el_position = '';
...
//	        }
	        ...
	        /* BLOG ITEMS
	        ================================================== */ 
	        $items = sf_blog_items($blog_type, $gutters, $columns, $fullwidth, $show_title, $show_excerpt, $show_details, $excerpt_length, $content_output, $show_read_more, $item_count, $category, $exclude_categories, $pagination, $sidebars, $width, $offset, $posts_order, $social_integration, $twitter_username, $instagram_id, $instagram_token);
