	...
	class SwiftPageBuilderShortcode_spb_row extends SwiftPageBuilderShortcode {
	    ...
	    public function content( $atts, $content = null ) {
			...
			if ($row_bg_type == "video") {
				if ($img_url[0] != "") {
					$output .= "\n\t".'<div class="spb-row-container spb-row-'.$wrap_type.' spb_parallax_asset sf-parallax sf-parallax-video parallax-'.$parallax_video_height.' spb_content_element bg-type-'.$bg_type.' '.$width.$row_el_class.'" data-v-center="'.$vertical_center.'" style="'.$inline_style.'">';			
				} else {
					$output .= "\n\t".'<div class="spb-row-container spb-row-'.$wrap_type.' spb_parallax_asset sf-parallax sf-parallax-video parallax-'.$parallax_video_height.' spb_content_element bg-type-'.$bg_type.' '.$width.$row_el_class.'" data-v-center="'.$vertical_center.'" style="'.$inline_style.'">';	
				}
				...
				if ($img_url[0] != "") {
					if ($parallax_image_movement == "stellar") {
						$output .= "\n\t".'<div class="spb-row-container spb-row-'.$wrap_type.' spb_parallax_asset sf-parallax parallax-'.$parallax_image_height.' parallax-'.$parallax_image_movement.' spb_content_element bg-type-'.$bg_type.' '.$width.$row_el_class.'" data-v-center="'.$vertical_center.'" data-parallax-speed="'.$parallax_image_speed.'" style="'.$inline_style.'">';
					} else {
						$output .= "\n\t".'<div class="spb-row-container spb-row-'.$wrap_type.' spb_parallax_asset sf-parallax parallax-'.$parallax_image_height.' parallax-'.$parallax_image_movement.' spb_content_element bg-type-'.$bg_type.' '.$width.$row_el_class.'" data-v-center="'.$vertical_center.'" style="'.$inline_style.'">';
					}
				} else {
					$output .= "\n\t".'<div class="spb-row-container spb-row-'.$wrap_type.' spb_parallax_asset sf-parallax parallax-'.$parallax_image_height.' spb_content_element bg-type-'.$bg_type.' '.$width.$row_el_class.'" data-v-center="'.$vertical_center.'" style="'.$inline_style.'">';
				}	
			} else {
				$output .= "\n\t".'<div class="spb-row-container spb-row-'.$wrap_type.' '.$width.$row_el_class.'" data-v-center="'.$vertical_center.'" style="'.$inline_style.'">'; 
			}
