	...
	*/
	...
	class SPBTemplateMenu implements SPBTemplateInterface {
	    ...
	    public function output( $post = null ) {
	        ...
	        if($is_empty) $output .= '<li class="spb_no_templates"><span>'.__('You have not saved any templates yet.', 'swift-framework-admin').'</span></li>';
	        return $output;
	    }
	}
	...
	class SPBElementsMenu implements SPBTemplateInterface {
	    ...
	    public function output( $post = null ) {
	        ...
	        if($is_empty) $output .= '<li class="spb_no_elements"><span>'.__('You have not saved any elements yet.', 'swift-framework-admin').'</span></li>';
	        return $output;
	    }
	}
