<?php
	...
	*/
    ...
    function add_ss_shortcodes_button() {
        ...
        echo '<a href="#TB_inline?width=480&inlineId=ss-shortcodes" class="thickbox button shortcode_btn_link" id="ss_add_button" title="' . __("Add Button", 'swift-framework-admin') . '">' . __("Add Button", "swift-framework-admin") . '</a>';
    }
            ...
            <div class="wrap">
                <div>
                    <div style="padding:0 15px;">
                        <h2 style="margin-bottom: 10px;"><?php _e("Insert Button", "swift-framework-admin"); ?></h2>
                        <span>
                            <?php _e("Select the various button options below, then press add button to add a button to the caption", "swift-framework-admin"); ?>
                        </span>
                    </div>
                    <div class="option" style="padding: 15px 15px 0;">
                    	<label for="button-size" style="width: 160px;display: inline-block;font-weight: bold;font-size: 14px;"><?php _e('Button size', 'swift-framework-admin'); ?></label>
                    ...
                    <div class="option" style="padding: 15px 15px 0;">
                    	<label for="button-colour" style="width: 160px;display: inline-block;font-weight: bold;font-size: 14px;"><?php _e('Button colour', 'swift-framework-admin'); ?></label>
                    	<select id="button-colour" name="button-colour" style="width: 200px;">
                    		...
                    		<option value="transparent-light"><?php _e('Transparent - Light', 'swift-framework-admin'); ?></option>
                    		<option value="transparent-dark"><?php _e('Transparent - Dark', 'swift-framework-admin'); ?></option>
                    	</select>
                    </div>
                    <div class="option" style="padding: 15px 15px 0;">
                    	<label for="button-type" style="width: 160px;display: inline-block;font-weight: bold;font-size: 14px;"><?php _e('Button type', 'swift-framework-admin'); ?></label>
                    ...
                    <div class="option" style="padding: 15px 15px 0;">
                    	<label for="button-dropshadow" class="for-checkbox" style="width: 160px;display: inline-block;font-weight: bold;font-size: 14px;"><?php _e('Button drop shadow', 'swift-framework-admin'); ?></label>
                    	<input id="button-dropshadow" class="checkbox" name="button-dropshadow" type="checkbox" style="margin-top:2px;"/>
                    </div>
                    <div class="option" style="padding: 15px 15px 0;">
                    	<label for="button-text" style="width: 160px;display: inline-block;font-weight: bold;font-size: 14px;"><?php _e('Button text', 'swift-framework-admin'); ?></label>
                    	<input id="button-text" name="button-text" type="text" value="<?php _e('Button text', 'swift-framework-admin'); ?>"/>
                    </div>
                    <div class="option" style="padding: 15px 15px 0;">
                    	<label for="button-url" style="width: 160px;display: inline-block;font-weight: bold;font-size: 14px;"><?php _e('Button URL', 'swift-framework-admin'); ?></label>
                    	<input id="button-url" name="button-url" type="text" value="http://"/>
                    </div>
                    <div class="option" style="padding: 15px 15px 0;">
                    	<label for="button-target" class="for-checkbox" style="width: 210px;display: inline-block;font-weight: bold;font-size: 14px;"><?php _e('Open link in a new window?', 'swift-framework-admin'); ?></label>
                    	<input id="button-target" class="checkbox" name="button-target" type="checkbox" style="margin-top:2px;" />
                    </div>
                    <div style="padding:15px;">
                        <input type="button" class="button-primary" value="<?php _e("Add Button", "swift-framework-admin"); ?>" onclick="ss_add_button();"/>&nbsp;&nbsp;&nbsp;
                    	<a class="button" style="color:#bbb;" href="#" onclick="tb_remove(); return false;"><?php _e("Cancel", "swift-framework-admin"); ?></a>
                    </div>
                </div>
            </div>
        </div>
