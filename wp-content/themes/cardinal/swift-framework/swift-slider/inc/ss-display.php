<?php
	...
	*/
	...
	<?php if ($swift_slider_slides->have_posts()) {
			...
			$swift_slider_output .= '<div id="'.$sliderID.'" class="swift-slider swiper-container" data-type="'.$type.'" data-fullscreen="'.$fullscreen.'" data-max-height="'.$max_height.'" data-loop="'.$loop.'" data-slide-count="'.$slide_count.'">';
			$swift_slider_output .= '<div class="swiper-wrapper">';
				...
				while ( $swift_slider_slides->have_posts() ) : $swift_slider_slides->the_post();
					...
					if ($bg_image_url != "") {
						...
						$swift_slider_output .= '<div class="swiper-slide '.$bg_type.'-slide" data-slide-id="'.$slide_ID.'" style="background-image: url('.$bg_image_url.');background-color: '.$bg_color.'" data-bg-align="'.$ss_background_valign.'" data-slide-img="'.$bg_image_url.'" data-style="'.$slide_style.'">';
					
					} else {
					
						$swift_slider_output .= '<div class="swiper-slide '.$bg_type.'-slide" data-slide-id="'.$slide_ID.'" style="background-color: '.$bg_color.'" data-style="'.$slide_style.'">';
				...
				if ($type == "slider" && $slide_count > 1 && ($nav == "1" || $nav == "yes" || $nav == "true")) {
					$swift_slider_output .= '<a class="swift-slider-prev" href="#"><i class="ss-navigateleft"></i></a>';
					$swift_slider_output .= '<a class="swift-slider-next" href="#"><i class="ss-navigateright"></i></a>';
				}
				...
				if ($type == "curtain") {
				$swift_slider_output .= '<a href="#" class="swift-slider-continue"><i class="ss-navigatedown"></i></a>';
				}
				
				$swift_slider_output .= '<div class="swift-slider-loader">
					<div class="spinner">
						<div class="rect1"></div>
						<div class="rect2"></div>
						<div class="rect3"></div>
