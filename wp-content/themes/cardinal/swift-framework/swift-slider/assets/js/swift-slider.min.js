 ...
 * Requires: jQuery 1.7+
 */
(function(a){if(typeof define==="function"&&define.amd){define(["jquery"],a)}else{if(typeof exports==="object"){module.exports=a}else{a(jQuery)}}}(function(d){var e=["wheel","mousewheel","DOMMouseScroll","MozMousePixelScroll"],l=("onwheel" in document||document.documentMode>=9)?["wheel"]:["mousewheel","DomMouseScroll","MozMousePixelScroll"],j=Array.prototype.slice,k,b;for(var f=e.length;f;){d.event.fixHooks[e[--f]]=d.event.mouseHooks}var g=d.event.special.mousewheel={version:"4.0.0-pre",setup:function(){if(this.addEventListener){for(var n=l.length;n;){this.addEventListener(l[--n],m,false)}}else{this.onmousewheel=m}d.data(this,"mousewheel-line-height",g._getLineHeight(this));d.data(this,"mousewheel-page-height",g._getPageHeight(this))},add:function(i){var o=i.data,n=o&&o.mousewheel;if(n){if("throttle" in n||"debounce" in n){g._delayHandler.call(this,i)}if("intent" in n){g._intentHandler.call(this,i)}}},trigger:function(n,i){if(!i){i=n;n=null}m.call(this,i);return false},teardown:function(){if(this.removeEventListener){for(var n=l.length;n;){this.removeEventListener(l[--n],m,false)}}else{this.onmousewheel=null}},_getLineHeight:function(i){return parseInt(d(i).offsetParent().css("fontSize"),10)},_getPageHeight:function(i){return d(i).height()},settings:{adjustOldDeltas:true},trigger:function(n,i){if(!i){i=n;n=null}m.call(this,i);return false},_fix:function(p){var t=0,o=0,n=0,i=0,s=d.event.fix(p);if("detail" in p){n=p.detail}if("wheelDelta" in p){n=p.wheelDelta*-1}if("wheelDeltaY" in p){n=p.wheelDeltaY*-1}if("wheelDeltaX" in p){o=p.wheelDeltaX*-1}if("axis" in p&&p.axis===p.HORIZONTAL_AXIS){o=n;n=0}if("deltaY" in p){n=p.deltaY}if("deltaX" in p){o=p.deltaX}if(n===0&&o===0){return}if(p.deltaMode===1){var q=d.data(this,"mousewheel-line-height");t*=q;n*=q;o*=q}else{if(p.deltaMode===2){var r=d.data(this,"mousewheel-page-height");t*=r;n*=r;o*=r}}i=Math.max(Math.abs(n),Math.abs(o));if(!b||i<b){b=i;if(a(p,i)){b/=40}}if(a(p,i)){t/=40;o/=40;n/=40}o=Math[o>=1?"floor":"ceil"](o/b);n=Math[n>=1?"floor":"ceil"](n/b);s.deltaX=o;s.deltaY=n;s.deltaFactor=b;s.deltaMode=0;s.type="mousewheel";return s},_intentHandler:function(z){var y,s,r,x,w,n=false,u=this,v=z.data.mousewheel.intent,q=v.interval||100,t=v.sensitivity||7,A=z.handler,p=function(B){x=B.pageX;w=B.pageY},o=function(){if((Math.abs(s-x)+Math.abs(r-w))<t){d(u).off("mousemove",p);n=true}else{s=x;r=w;y=setTimeout(o,q)}},i=function(B){if(n){return A.apply(u,arguments)}else{c(v,B)}};d(u).on("mouseenter",function(){s=event.pageX;r=event.pageY;d(u).on("mousemove",p);y=setTimeout(o,q)}).on("mouseleave",function(){if(y){clearTimeout(y)}d(u).off("mousemove",p);n=false});z.handler=i},_delayHandler:function(x){var o,v,s,r=this,n="throttle" in x.data.mousewheel?"throttle":"debounce",t=x.data.mousewheel[n],q="leading" in t?t.leading:n==="debounce"?false:true,w="trailing" in t?t.trailing:true,u=t.delay||100,p=n==="throttle"?u:t.maxDelay,y=x.handler,i=function(E){var D=arguments,A=function(){if(v){clearTimeout(v)}o=null;v=null;s=null},F=function(){s=+new Date();return y.apply(r,D)},B=function(){v=null;return F()},C=function(){A();if(w){return F()}},z;if(o){clearTimeout(o)}else{if(q){z=F()}}o=setTimeout(C,u);if(n==="throttle"){if(p&&(+new Date()-s)>=p){z=B()}}else{if(p&&!v){v=setTimeout(B,p)}}c(t,E);return z};x.handler=i}};function m(o){var n=o?o.originalEvent||o:window.event,i=j.call(arguments,1);o=g._fix(n);i.unshift(o);if(k){clearTimeout(k)}k=setTimeout(h,200);return d.event.dispatch.apply(this,i)}function h(){b=null}function a(n,i){return g.settings.adjustOldDeltas&&n.type==="mousewheel"&&i%120===0}function c(i,n){if(i.preventDefault===true){n.preventDefault()}if(i.stopPropagation===true){n.stopPropagation()}}}));