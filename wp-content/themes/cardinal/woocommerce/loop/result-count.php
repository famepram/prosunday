...
<div class="woocommerce-count-wrap">
	...
	<p class="woocommerce-show-products">
		...
		<a class="show-products-link" href="?show_products=<?php echo $products_per_page; ?>"><?php echo $products_per_page; ?></a>/<a class="show-products-link" href="?show_products=<?php echo $products_per_page * 2; ?>"><?php echo $products_per_page * 2; ?></a>/<a href="<?php echo $shop_page_url; ?>?show_products=<?php echo $total; ?>"><?php _e("All", "swiftframework"); ?></a>
	</p>
	<?php } ?>
</div>