...
if ( $products->have_posts() ) : ?>
	...
	<div class="product-carousel spb_content_element">
		...
		<div class="title-wrap clearfix">
			...
			<div class="carousel-arrows"><a href="#" class="carousel-prev"><i class="ss-navigateleft"></i></a><a href="#" class="carousel-next"><i class="ss-navigateright"></i></a></div>
		</div>
		
		<div class="related products carousel-items <?php echo $gutter_class; ?> product-type-<?php echo $product_display_type; ?>" id="carousel-<?php echo $sf_carouselID; ?>" data-columns="<?php echo $woocommerce_loop['columns']; ?>>">
