			...
			$this->sections[] = array(
				...
				'fields' => array(	
					...
					array(
						'id' => 'page_transition',
						'type' => 'select',
						'required'  => array('enable_page_transitions', '=', '1'),
						'title' => __('Page Transition', 'swift-framework-admin'),
						'subtitle' => __('Select which style of page transition to show', 'swift-framework-admin'),
						'options' => array(
				...
				$this->sections[] = array(
					...
					'fields' => array(
						...
						array(
						    ...
						    'data'      => 'post_types',
						    'multi'     => true,
						    'default'	=> array('page', 'post', 'portfolio', 'team'),
				...
				$this->sections[] = array(
					...
					'fields' => array(
						...
						array(
							...
							'desc' => '',
							'options' => array(
								'header-1' => array('title' => '', 'img' => $template_directory.'/images/cardinal_header_1.png'),
								'header-2' => array('title' => '', 'img' => $template_directory.'/images/cardinal_header_2.png'),
								'header-3' => array('title' => '', 'img' => $template_directory.'/images/cardinal_header_3.png'),
								'header-4' => array('title' => '', 'img' => $template_directory.'/images/cardinal_header_4.png'),
								'header-5' => array('title' => '', 'img' => $template_directory.'/images/cardinal_header_5.png'),
								'header-6' => array('title' => '', 'img' => $template_directory.'/images/cardinal_header_6.png'),
								'header-7' => array('title' => '', 'img' => $template_directory.'/images/cardinal_header_7.png'),
								'header-8' => array('title' => '', 'img' => $template_directory.'/images/cardinal_header_8.png'),
								'header-9' => array('title' => '', 'img' => $template_directory.'/images/cardinal_header_9.png'),
								'header-vert' => array('title' => '', 'img' => $template_directory.'/images/cardinal_header_vert.png'),
								'header-vert-right' => array('title' => '', 'img' => $template_directory.'/images/cardinal_header_vert_right.png')
							),
							'default' => 'header-7'
							),
						array(
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'output' => array('#logo h1'), // An array of CSS selectors to apply this font style to dynamically
						'compiler' => array('#logo h1'), // An array of CSS selectors to apply this font style to dynamically
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'color'=>false,
						'letter-spacing'=>true,
						'output' => array('#main-nav, #header nav, #vertical-nav nav, .header-9#header-section #main-nav, #overlay-menu nav, #mobile-menu, #one-page-nav li .hover-caption'), // An array of CSS selectors to apply this font style to dynamically
						'compiler' => array('#main-nav, #header nav,#vertical-nav nav, .header-9#header-section #main-nav, #overlay-menu nav, #mobile-menu, #one-page-nav li .hover-caption'), // An array of CSS selectors to apply this font style to dynamically
						'units'=> 'px', // Defaults to px
						'default' => array(
							'font-size'=>'18px',
							'font-family'=>'Source Sans Pro',
...
//			}
		...
		public function setArguments() {
			...
			$this->args = array(
				...
				'opt_name'          	=> 'sf_cardinal_options', // This is where your data is stored in the database and also becomes your global variable name.
