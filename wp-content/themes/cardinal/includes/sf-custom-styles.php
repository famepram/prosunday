	...
	*/
    ...
    if ( ! function_exists( 'sf_custom_styles' ) ) {
        function sf_custom_styles() {
            ...
            // Standard Styling
            $accent_color               = sf_get_option( 'accent_color', '#fe504f' );
            ...
            // Page Styling
            $page_bg_color             = sf_get_option( 'page_bg_color', '#222222' );
            ...
            // Logo Setup
            $logo_height = $logo_maxheight = $header_height = $retina_logo_width = $logo_padding = "";
            ...
            if ( $header_layout == "header-3" || $header_layout == "header-4" || $header_layout == "header-5" ) {
                ...
                if ( $header_height < 60 ) {
                    $header_height = $header_height + 40 . 'px';
                } else {
            ...
            $nav_sm_bg_hover_color      = sf_get_option( 'nav_sm_bg_hover_color', '#f7f7f7' );
            ...
            $tweet_slider_bg         = sf_get_option( 'tweet_slider_bg', '#1dc6df' );
            $tweet_slider_text       = sf_get_option( 'tweet_slider_text', '#ffffff' );
            $tweet_slider_link       = sf_get_option( 'tweet_slider_link', '#339933' );
            $tweet_slider_link_hover = sf_get_option( 'tweet_slider_link_hover', '#ffffff' );
            $testimonial_slider_bg   = sf_get_option( 'testimonial_slider_bg', '#1dc6df' );
            ...
            if ( ! $enable_responsive ) {
                ...
                echo '
					...
					.navbar-fixed-bottom .container {
					  width: ' . $site_contwidth . '!important;
					...
					#container.boxed-layout, .boxed-layout #header-section .is-sticky #main-nav.sticky-header, .boxed-layout #header-section.header-6 .is-sticky #header.sticky-header {
						width: ' . $site_boxedwidth . ';
					}
					#swift-slider {
						min-width: ' . $site_contwidth . ';
					}
            ...
            echo 'input[type="text"]:focus, input[type="email"]:focus, textarea:focus, .bypostauthor .comment-wrap .comment-avatar,.search-form input:focus, .wpcf7 input:focus, .wpcf7 textarea:focus, .ginput_container input:focus, .ginput_container textarea:focus, .mymail-form input:focus, .mymail-form textarea:focus, input[type="tel"]:focus, input[type="number"]:focus {border-color: ' . $accent_color . '!important;}';
            ...
            if ( $body_bg_use_image ) {
                if ( $body_upload_bg && $body_upload_bg['url'] != "" ) {
                    ...
                    echo 'body, .layout-fullwidth #container {background: ' . $page_bg_color . ' url(' . $body_preset_bg['url'] . ') repeat center top fixed;}';
                }
                if ( $page_bg_color != "" ) {
            ...
            echo '.ajax-search-wrap {background-color:' . $header_bg_color . '}';
            echo '.ajax-search-wrap, .ajax-search-results, .search-result-pt .search-result, .vertical-header .ajax-search-results {border-color: ' . $header_border_color . ';}';
            ...
            // LOGO STYLES
            if ( $header_height != "" ) {
                echo '.full-center #main-navigation ul.menu > li > a, .full-center .header-right ul.menu > li > a, .full-center nav.float-alt-menu ul.menu > li > a, .full-center #logo h1, .full-center .header-right div.text {height:' . $header_height . ';line-height:' . $header_height . ';}';
            ...
            if ( $logo_height != "" ) {
                echo '#logo, #mobile-logo, .header-left, .header-right {height:' . $logo_height . 'px;}';
            ...
            echo 'li.menu-item.sf-mega-menu > ul.sub-menu > li {border-right-color: ' . $nav_divider_color . ';border-right-style: ' . $nav_divider . ';}';
            if ( $nav_divider == "none" ) {
            ...
            echo 'nav ul.menu > li.menu-item.sf-menu-item-btn > a > span.menu-item-text {border-color: ' . $nav_text_color . ';background-color: ' . $nav_text_color . ';color: ' . $nav_text_hover_color . ';}';
            echo 'nav ul.menu > li.menu-item.sf-menu-item-btn:hover > a > span.menu-item-text {border-color: ' . $accent_color . '; background-color: ' . $accent_color . '; color: ' . $accent_alt_color . ';}';
            ...
            if ( $nav_hover_style == "bold" ) {
                ...
                echo '#main-nav ul.menu > li, .full-center nav#main-navigation ul.menu > li, .full-center nav.float-alt-menu ul.menu > li, .full-center #header nav.float-alt-menu ul.menu > li {border-width: 0;}';
                echo '#main-nav ul.menu > li:first-child, .full-center nav#main-navigation ul.menu > li:first-child {border-width: 0;margin-left: -15px;}';
                ...
                echo 'nav .menu > li:hover > a {background-color: ' . $nav_bg_hover_color . ';color: ' . $nav_text_hover_color . '!important;}';
            }
            ...
            echo 'nav .menu ul.sub-menu li.current-menu-ancestor > a, nav .menu ul.sub-menu li.current-menu-item > a {color: ' . $nav_sm_selected_text_color . '!important; background: ' . $nav_sm_bg_hover_color . ';}';
            ...
            echo '#overlay-menu {background-color: rgba(' . $overlay_menu_bg_color_rgb["red"] . ',' . $overlay_menu_bg_color_rgb["green"] . ',' . $overlay_menu_bg_color_rgb["blue"] . ', 0.95);}';
            ...
            echo '.blog-item .inst-icon {background: ' . $accent_alt_color . ';color: ' . $accent_color . ';}';
            echo '.blog-item .tweet-icon, .blog-item .post-icon, .blog-item .inst-icon {background: ' . $bold_rp_hover_bg . ';color: ' . $bold_rp_hover_text . '!important;}';
            echo '.blog-item:hover .tweet-icon, .blog-item:hover .post-icon, .blog-item:hover .inst-icon {background: ' . $bold_rp_hover_text . ';}';
            echo '.blog-item:hover .tweet-icon i, .blog-item:hover .post-icon i, .blog-item:hover .inst-icon i {color: ' . $bold_rp_hover_bg . '!important;}';
            ...
            echo '.bold-design .posts-type-bold .recent-post .details-wrap h2:after, .bold-design .posts-type-bold .recent-post .details-wrap h2:after, .bold-design .blog-grid-items .blog-item .tweet-text:after, .bold-design .blog-grid-items .blog-item .quote-excerpt:after, .bold-design .blog-grid-items .blog-item h2:after {background: ' . $bold_rp_text . ';}';
            echo '.bold-design .posts-type-bold .recent-post:hover .details-wrap h2:after, .bold-design .posts-type-bold .recent-post:hover .details-wrap h2:after, .bold-design .blog-grid-items .blog-item:hover .tweet-text:after, .bold-design .blog-grid-items .blog-item:hover .quote-excerpt:after, .bold-design .blog-grid-items .blog-item:hover h2:after {background: ' . $bold_rp_hover_text . ';}';
            ...
            echo '.bold-design .testimonials > li:before {background-color: ' . $inner_page_bg_color . '}';
            ...
            echo '.spb_tour .nav-tabs li.active a, .spb_tabs .nav-tabs li.active a {color: ' . $accent_color . ';}';
            echo '.spb_accordion_section > h4:hover .ui-icon:before {border-color: ' . $accent_color . ';}';
            echo '.spb_tour .ui-tabs .ui-tabs-nav li a, .nav-tabs>li.active>a:hover {border-color: ' . $section_divide_color . '!important;}';
            ...
            echo '.woocommerce form.cart button.single_add_to_cart_button, .woocommerce form.cart .yith-wcwl-add-to-wishlist a, .woocommerce .quantity input, .woocommerce .quantity .minus, .woocommerce .quantity .plus {color: ' . $link_text_color . ';}';
            ...
            echo '.woocommerce a.button:hover, .woocommerce .coupon input.apply-coupon:hover, .woocommerce .shipping-calculator-form .update-totals-button button:hover, .woocommerce .quantity .plus:hover, .woocommerce .quantity .minus:hover, .add_review a:hover, .woocommerce #review_form #respond .form-submit input:hover, .lost_reset_password p.form-row input[type="submit"]:hover, .track_order p.form-row input[type="submit"]:hover, .change_password_form p input[type="submit"]:hover, .woocommerce table.my_account_orders .order-actions .button:hover, .woocommerce .widget_price_filter .price_slider_amount .button:hover, .woocommerce.widget .buttons a:hover, .woocommerce .wishlist_table tr td.product-add-to-cart a:hover, .woocommerce input.button[name="save_address"]:hover, .woocommerce input[name="apply_coupon"]:hover, .woocommerce form.register input[type="submit"]:hover, .woocommerce form.cart .yith-wcwl-add-to-wishlist a:hover, .load-more-btn:hover, #wew-submit-email-to-notify:hover {background: '.$accent_color.'; color: '.$accent_alt_color.';}';
            ...
            // BOLD STYLES
            echo '.bold-design .spb_accordion .spb_accordion_section > h4.ui-state-default, .bold-design .nav-tabs > li a {background-color:' . $alt_bg_color . ';}';
            echo '.bold-design .spb_accordion .spb_accordion_section > h4.ui-state-active, .bold-design .nav-tabs > li.active a {background-color:' . $secondary_accent_color . '!important;}';
            echo '.bold-design .spb_accordion .spb_accordion_section > h4:after, .bold-design .nav-tabs > li a:after {border-top-color: ' . $secondary_accent_color . ';}';
            echo '.bold-design .spb_tour .nav-tabs > li a:after {border-left-color: ' . $secondary_accent_color . ';}';
            echo '.bold-design .spb_accordion .spb_accordion_section > h4.ui-state-active a, .bold-design .spb_accordion .spb_accordion_section > h4.ui-state-active .ui-icon, .bold-design .nav-tabs > li.active a {color:' . $secondary_accent_alt_color . '!important;}';
            echo '.bold-design .spb_accordion .spb_accordion_section > h4.ui-state-hover, .bold-design .nav-tabs > li:hover a {background-color:' . $accent_color . ';}';
            echo '.bold-design .spb_accordion .spb_accordion_section > h4.ui-state-hover a, .bold-design .spb_accordion .spb_accordion_section > h4.ui-state-hover .ui-icon, .bold-design .nav-tabs > li:hover a {color:' . $accent_alt_color . ';}';
            echo '.bold-design .title-wrap .carousel-arrows a {background-color: ' . $secondary_accent_color . ';color: ' . $secondary_accent_alt_color . ';}';
            echo '.bold-design .title-wrap .carousel-arrows a:hover {background-color: ' . $accent_color . ';color: ' . $accent_alt_color . ';}';
            echo '.product-type-standard .product .cart-overlay .shop-actions > a, .product-type-standard .product figure .cart-overlay .yith-wcwl-add-to-wishlist a, .product-type-standard .product .cart-overlay .shop-actions > .jckqvBtn {background-color: ' . $accent_color . ';color: ' . $accent_alt_color . ';}';
            echo '.product-type-standard .product .cart-overlay .shop-actions > a:hover, .product-type-standard .product figure .cart-overlay .yith-wcwl-add-to-wishlist a:hover, .woocommerce .product-type-standard .product figure .cart-overlay .shop-actions > a.product-added {background-color: ' . $secondary_accent_color . ';color: ' . $secondary_accent_alt_color . '!important;}';

            // BRIGHT STYLES
            echo '.bright-design h3.spb-heading:before, .bright-design h3.spb-heading:after {border-color:' . $section_divide_color . ';}';
            echo '.bright-design .spb_accordion .spb_accordion_section > h4.ui-state-default, .bright-design .nav-tabs > li.active a {background-color:' . $alt_bg_color . ';}';
            echo '.bright-design .spb_accordion .spb_accordion_section > h4.ui-state-active {background-color:' . $inner_page_bg_color . '!important;}';
            echo '.bright-design .spb_accordion .spb_accordion_section > h4:hover a, .bright-design .spb_accordion .spb_accordion_section > h4.ui-state-active a, .bright-design .spb_accordion .spb_accordion_section > h4.ui-state-active .ui-icon, .bright-design .nav-tabs > li.active a, .bright-design .spb_tour .nav-tabs li:hover a {color:' . $accent_color . '!important;}';
            echo '.bright-design .posts-type-list .recent-post:hover {background-color:' . $accent_color . '!important;}';
            echo '.bright-design .posts-type-list .recent-post:hover .details-wrap > h4 a, .bright-design .posts-type-list .recent-post:hover .details-wrap * {color: ' . $accent_alt_color . ';}';
            echo '.bright-design .testimonials > li:before {color: ' . $accent_color . ';}';
