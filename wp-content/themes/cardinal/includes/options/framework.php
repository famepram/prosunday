...
//                $comparison = $field['required'][1];
            ...
            function _admin_bar_menu() {
                ...
                if ( $menu ) {
                    ...
                    $nodeargs = array(
                        ...
                        'title' => "<span class='ab-icon dashicons-admin-generic'></span>" . $theme_data->get( 'Name' ) . " " . __( 'Options', 'swift-framework-admin' ),
            ...
            public function _load_page() {
                ...
                if ( true == $this->show_hints ) {
                    ...
                    $tab = array(
                        'id'      => 'redux-hint-tab',
                        'title'   => __( 'Hints', 'swift-framework-admin' ),
                        'content' => __( '<p>' . $msg . '</p>', 'swift-framework-admin' )
                    );
